      ...
      <div className="flex-1 overflow-y-auto p-3">
        {sidebarTab === "tables" && (
          !activeConnection ? (
            <div className="flex flex-col items-center justify-center h-full text-center gap-2.5 px-4">
              ...
              <p className="text-xs text-text-muted leading-relaxed">Connect to a database to browse tables</p>
            </div>
          ) : (
        ...
        {sidebarTab === "history" && (
          <div className="flex flex-col items-center justify-center h-full text-center gap-2.5 px-4">
            ...
            <p className="text-xs text-text-muted leading-relaxed">Query history will appear here</p>
          </div>
        )}
      </div>
    </aside>
